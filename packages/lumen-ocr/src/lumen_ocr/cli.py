"""
Command-line interface for Lumen OCR Service.
"""
...
Examples:
  ...
  lumen-ocr --config config/ocr.yaml
...
""",
    ...
    # Lazy import server module to avoid heavy dependencies (OpenCV, ONNXRuntime) on startup
    try:
        from lumen_ocr.server import serve, setup_logging
